                ...
                <div class="card">
                    <div class="card-header">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <span id="card_title">
                                {{ __('Product Has Warehouse') }}
                            </span>

                             <div class="float-right">
                                <a href="{{ route('product-has-warehouses.create') }}" class="btn btn-primary btn-sm float-right"  data-placement="left">
                                  {{ __('Create New') }}
                                </a>
                              </div>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    @foreach ($productHasWarehouses as $productHasWarehouse)
                                        <tr>
                                            <td>{{ ++$i }}</td>
